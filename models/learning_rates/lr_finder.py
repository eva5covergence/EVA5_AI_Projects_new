...
def get_best_linear_lr_sgd(model, trainloader, val_loader, lr=1e-7, momentum=0.9, end_lr=100, num_iter=100):
    """
    ...
    plots the evaluation loss versus learning rate. This approach typically produces more precise curves because 
    the evaluation loss is more susceptible to divergence but it takes significantly longer to perform the test, 
