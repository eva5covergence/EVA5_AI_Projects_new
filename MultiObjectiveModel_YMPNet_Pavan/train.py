...
def train(planer_args):
    ...
    # print("\n\n****** Model Information *******\n\n")
    # print(model)
    # print_summary(model,'YMPNet Model')
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _,depth_targets,_,_) in pbar:  # batch -------------------------------------------------------------
            ...
            depth_preds = midas_post_processing(depth_preds)
...
if __name__ == '__main__':
    ...
    if not opt.evolve:  # Train normally
        ...
        train(planer_args)  # train normally
