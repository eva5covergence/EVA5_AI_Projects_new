...
from planer_models.refinement_net import *
from config import PlaneConfig
from options import parse_args


# def get_planer_config():
#     args = parse_args()
...
class YMPNet(BaseModel, MaskRCNN):
    """Network for monocular depth estimation.
    """

    def __init__(self, yolo_props, config=None, path=None, features=256, non_negative=True, inference=False):
        """Init.
        Args:
    ...
    def forward(self, x, sample):
        ...
        ## PlanerCNN model building
        maskrcnn_model = MaskRCNN(self.config, [layer_1,layer_2,layer_3,layer_4])
        maskrcnn_model.cuda()
