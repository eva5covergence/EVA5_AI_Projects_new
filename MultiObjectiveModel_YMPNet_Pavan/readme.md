...
## Sesson 15 Build a Multiobjective model to do:
...
- ### Data collection
  ...
  - House interior videos from youtube was downloaded using automated script. The script does the following things.
   ...
   The entire dataset can be viewed [here](https://drive.google.com/drive/folders/1PamZvBz_TkXYYXHBd7pXP92t-chF-4E9?usp=sharing)
