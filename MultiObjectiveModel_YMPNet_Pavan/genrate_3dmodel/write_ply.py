# https://github.com/svip-lab/PlanarReconstruction/blob/master/utils/write_ply.py#L33
...
K_inv_dot_xy_1 = get_K_inv_dot_xy_1(480, 640)
...
def writePLYFileDepth(folder, index, depth, segmentation):
    h, w = 480, 640
    imageFilename = str(index) + '_segmentation_0_final.png'
...
if __name__ == '__main__':
    import cv2 
    seg = cv2.imread("single_rgb_sample/6_segmentation_0_final.png",0)
    depth = cv2.imread("single_rgb_sample/6_depth_0_final_np.png",0)
    writePLYFileDepth("single_rgb_sample","6",depth,seg)
    #(folder, index, depth, segmentation)